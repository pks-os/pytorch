...
def bundled_autotune_cache_default() -> Optional[bool]:
    return _get_tristate_env("TORCHINDUCTOR_BUNDLED_AUTOTUNE_CACHE")
...
# True: Enables the cache
# None: Not set -- Off for OSS, JustKnobs based for internal
bundled_autotune_cache: Optional[bool] = bundled_autotune_cache_default()
